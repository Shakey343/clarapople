      ...
      <Container className="relative">
        <div className="flex justify-center">
          <div className="w-[800px] h-[750px] relative">
            {!atPageOne && (
              <img
                className="absolute top-32 left-28 w-[200px] h-[160px] sm:w-[400px] sm:h-[300px] sm:top-10 sm:left-20 md:top-20 md:left-20 md:w-[400px] md:h-[300px] lg:-top-10 lg:left-0 lg:w-[600px] lg:h-[468px] drop-shadow-lg"
            ...
            {!atPageOne && (
              <img
                className="absolute bottom-80 left-60 h-[160px] w-[140px] sm:left-80 sm:bottom-48 sm:h-[280px] sm:w-[250px] md:bottom-48 md:left-[400px] lg:bottom-28 lg:left-[480px] lg:w-[361px] lg:h-[456px] drop-shadow-lg"
        ...
        <Upcoming className="absolute top-[75vh] min-w-[600px] text-slate-50 drop-shadow-lg" />
      </Container>
    </div>
  );
};
