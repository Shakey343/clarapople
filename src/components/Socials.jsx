...
const Socials = () => {
  return (
    <div className="fixed sm:right-10 bottom-0 sm:top-28 w-full flex justify-evenly sm:justify-center z-10 bg-claraRed sm:w-0 sm:flex-col sm:items-center sm:bg-transparent">
      {links.map((link, i) => (
